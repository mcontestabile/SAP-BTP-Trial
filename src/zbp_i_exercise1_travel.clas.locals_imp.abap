...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD get_instance_features.
    ...
    READ ENTITIES OF ZI_Exercise1_Travel IN LOCAL MODE
      ENTITY Travel
  ...
  METHOD acceptTravel.
    ...
    MODIFY ENTITIES OF ZI_Exercise1_Travel IN LOCAL MODE
      ENTITY Travel
         UPDATE
           FIELDS ( TravelStatus )
  ...
  METHOD validateCustomer.
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-CustomerID IS INITIAL OR NOT line_exists( customers_db[ customer_id = travel-CustomerID ] ).
        ...
        APPEND VALUE #(  %tky        = travel-%tky
                         %state_area = 'VALIDATE_CUSTOMER'
                         %msg        = NEW zmc_exercise1_rap(
                                           severity   = if_abap_behv_message=>severity-error
                                           textid     = zmc_exercise1_rap=>customer_unknown
    ...
    LOOP AT travels INTO DATA(travel).
      ...
      IF travel-EndDate < travel-BeginDate.
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW zmc_exercise1_rap(
                                                 severity  = if_abap_behv_message=>severity-error
                                                 textid    = zmc_exercise1_rap=>date_interval
      ...
      ELSEIF travel-BeginDate < cl_abap_context_info=>get_system_date( ).
        ...
        APPEND VALUE #( %tky               = travel-%tky
                        ...
                        %msg               = NEW zmc_exercise1_rap(
                                                 severity  = if_abap_behv_message=>severity-error
                                                 textid    = zmc_exercise1_rap=>begin_date_before_system_date
                                                 begindate = travel-BeginDate )
      ...
      IF is_update_requested = abap_true.
        ...
        IF has_before_image = abap_true.
          ...
          IF update_granted = abap_false.
            APPEND VALUE #( %tky        = travel-%tky
                            %msg        = NEW zmc_exercise1_rap( severity = if_abap_behv_message=>severity-error
                                                            textid   = zmc_exercise1_rap=>unauthorized )
                          ) TO reported-travel.
          ENDIF.
