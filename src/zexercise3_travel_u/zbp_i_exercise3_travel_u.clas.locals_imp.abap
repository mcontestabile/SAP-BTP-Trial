...
CLASS lhc_Travel IMPLEMENTATION.
  ...
  METHOD update.
    ...
    LOOP AT entities ASSIGNING FIELD-SYMBOL(<entity>).
      ...
      legacy_entity_x-_intx = CORRESPONDING zsexercise3_travel_x( <entity> MAPPING FROM ENTITY ).
...
CLASS lsc_ZI_EXERCISE3_TRAVEL_U DEFINITION INHERITING FROM cl_abap_behavior_saver.
  PROTECTED SECTION.
...
CLASS lsc_ZI_EXERCISE3_TRAVEL_U IMPLEMENTATION.
